...
def get_bubble_position(row_idx, col_idx):
    pos_x = col_idx * CELL_SIZE + (BUUBLE_WIDTH // 2) + (row_idx % 2) * (CELL_SIZE // 2)
    pos_y = row_idx * CELL_SIZE + (BUUBLE_HEIGHT // 2) + wall_height
    return pos_x, pos_y
